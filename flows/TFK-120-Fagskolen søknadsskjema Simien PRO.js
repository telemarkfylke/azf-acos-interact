const description = 'Fagskolen søknadsskjema Simien Pro'
  ...
  archive: { // archive må kjøres for å kunne kjøre signOff (noe annet gir ikke mening)
    ...
    options: {
      mapper: (flowStatus, base64, attachments) => {
        const archiveTitle = `Søknad kurs - Simien Pro - ${flowStatus.parseJson.result.SavedValues.Login.FirstName} ${flowStatus.parseJson.result.SavedValues.Login.LastName}`
        const publicTitle = 'Søknad kurs - Simien Pro'
        ...
        return [
          {
            ...
            fields: {
              ...
              sokertype: skjemaData.Pamelding_til_kurs.Hvem_skal_betal.Velg,
              ...
              oppstartmnd: skjemaData.Pamelding_til_kurs.Gruppe.Velg_maned_for_oppstart,
              samtykkeInfo: skjemaData.Samtykke.Samtykke2.Jeg_\u00F8nsker_\u00E5_mo,
              fakturareferanse: skjemaData.Pamelding_til_kurs.Faktura_ref.Refferanse_p\u00E5_f
