    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          description: 'Elevavtale signert - leieavtale',
          type: 'Elevavtale signert - leieavtale' // Required. A short searchable type-name that distinguishes the statistic element
        }
      }
    }
  },
