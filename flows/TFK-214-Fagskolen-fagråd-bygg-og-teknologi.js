const description = 'Fagskolen - Fagråd Bygg og Teknologi'
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          parameter: {
            CaseType: 'Sak',
            Project: nodeEnv === 'production' ? '26-338' : '26-10',
            Title: `Samarbeidsavtale fagråd - bygg og teknologi - ${companyName}`,
            UnofficialTitle: '',
            Status: 'B',
            AccessCode: 'U',
            Paragraph: '',
            ...
            Files: [
              {
                ...
                Status: 'B',
                Title: `Samarbeidsavtale fagråd - bygg og teknologi - ${companyName}`,
                UnofficialTitle: `Samarbeidsavtale fagråd - bygg og teknologi - ${companyName}`,
                VersionFormat: 'A'
              },
              ...p360Attachments
            ],
  ...
  sharepointList: {
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return [
          {
            testListUrl: 'https://telemarkfylke.sharepoint.com/sites/FAGS-ByggogMaskinFagskolenVTFK/Lists/fagrad/AllItems.aspx',
            prodListUrl: 'https://telemarkfylke.sharepoint.com/sites/FAGS-ByggogMaskinFagskolenVTFK/Lists/fagrad/AllItems.aspx',
            uploadFormPdf: true,
    ...
    options: {
      mapper: (flowStatus) => {
        return {
          ...
          description,
          type: 'Samarbeidsavtale fagråd bygg teknologi'
        }
      }
    }
  },
