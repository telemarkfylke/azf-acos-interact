const description = 'Fagskolen - Påmelding til mattekurs'
  ...
  archive: { // archive må kjøres for å kunne kjøre signOff (noe annet gir ikke mening)
    ...
    options: {
      mapper: (flowStatus, base64, attachments) => {
        const archiveTitle = `Påmelding kurs i matematikk - ${flowStatus.parseJson.result.SavedValues.Login.FirstName} ${flowStatus.parseJson.result.SavedValues.Login.LastName}`
        const publicTitle = 'Påmelding kurs i matematikk'
  ...
  sharepointList: {
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return [
          {
            testListUrl: 'https://telemarkfylke.sharepoint.com/sites/Innfringskursimatematikk-Pmelding/Lists/PaamledingForkursMatematikk/AllItems.aspx',
            prodListUrl: 'https://telemarkfylke.sharepoint.com/sites/Innfringskursimatematikk-Pmelding/Lists/PaamledingForkursMatematikk/AllItems.aspx',
            uploadFormPdf: true,
            ...
            fields: {
              ...
              land: skjemaData.Informasjon_om.Opplysninger.Land
            }
          }
        ]
      }
