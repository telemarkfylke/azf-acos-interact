const description = 'Fagskolen Helse - Intensjonsavtale for praksis'
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          parameter: {
            CaseType: 'Sak',
            Project: nodeEnv === 'production' ? '26-321' : '26-8',
            Title: `Intensjonsavtale for praksis - Fagskolen Helse - ${companyName}`,
            UnofficialTitle: '',
            Status: 'B',
            AccessCode: 'U',
            Paragraph: '',
            ...
            Files: [
              {
                ...
                Status: 'B',
                Title: `Intensjonsavtale for praksis - Fagskolen Helse - ${companyName}`,
                UnofficialTitle: `Intensjonsavtale for praksis - Fagskolen Helse - ${companyName}`,
                VersionFormat: 'A'
              },
              ...p360Attachments
            ],
  ...
  sharepointList: {
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return [
          {
            testListUrl: 'https://telemarkfylke.sharepoint.com/sites/FAGS-Elektroniskeskjemaer/Lists/IntensjonsavtalePraksis/AllItems.aspx',
            prodListUrl: 'https://telemarkfylke.sharepoint.com/sites/FAGS-Elektroniskeskjemaer/Lists/IntensjonsavtalePraksis/AllItems.aspx',
            uploadFormPdf: true,
    ...
    options: {
      mapper: (flowStatus) => {
        return {
          ...
          description,
          type: 'Intensjonsavtale praksis helse'
        }
      }
    }
  },
