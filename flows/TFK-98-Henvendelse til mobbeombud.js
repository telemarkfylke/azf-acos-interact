const description = 'TFK-98 - Henvendelse til ombud for barn og unge'
      ...
      mapper: (flowStatus, base64, attachments) => {
        ...
        return {
          ...
          parameter: {
            ...
            Files: [
              {
                ...
                Format: 'pdf',
                Status: 'F',
                Title: 'Henvendelse til ombud for barn og unge',
                VersionFormat: 'A'
              },
              ...p360Attachments
            ],
            ...
            Status: 'J',
            Title: 'Henvendelse til ombud for barn og unge',
            UnofficialTitle: `Henvendelse til ombud for barn og unge - ${barnet.Navn}`,
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          description,
          type: 'Henvendelse til ombud for barn og unge',
