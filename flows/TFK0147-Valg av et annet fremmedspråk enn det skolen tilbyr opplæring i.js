const title = 'Valg av et annet fremmedspråk enn det skolen tilbyr opplæring i'
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          department: '',
          description,
          type: 'Søknad om valg av annet fremmedspråk', // Required. A short searchable type-name that distinguishes the statistic element
          // optional fields:
