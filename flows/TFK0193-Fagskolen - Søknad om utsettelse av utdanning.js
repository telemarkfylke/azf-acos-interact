...
const description = 'Søknad om utsettelse av utdanning'
module.exports = {
  config: {
    enabled: true,
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          type: 'Utsettelse av utdanning' // Required. A short searchable type-name that distinguishes the statistic element
        }
      }
    }
  },
