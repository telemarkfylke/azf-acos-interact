    ...
    options: {
      ...
      */
      mapper: (flowStatus) => { // for å opprette person basert på fødselsnummer
        ...
        return {
          ssn: flowStatus.parseXml.result.ArchiveData.Fnr // Sjekk denne ekstra siden det er et fritekstfelt i skjemaet
        }
      }
    }
  },
            ...
            Files: [
              {
                ...
                Format: 'pdf',
                Status: 'F',
                Title: 'Henvisning til pedagogisk-psykologisk tjeneste (PPT)',
                VersionFormat: 'A'
              },
              ...p360Attachments
            ],
            Paragraph: 'Offl. § 13 jf. fvl. § 13 (1) nr.1',
            ResponsibleEnterpriseRecno: nodeEnv === 'production' ? '200472' : '200', // Tema fag-, yrkes- og voksenopplæring
