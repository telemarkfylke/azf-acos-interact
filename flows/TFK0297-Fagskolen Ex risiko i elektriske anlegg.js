const description = 'Fagskolen - Ex risiko i elektriske anlegg'
  ...
  archive: { // archive må kjøres for å kunne kjøre signOff (noe annet gir ikke mening)
    ...
    options: {
      mapper: (flowStatus, base64, attachments) => {
        ...
        const archiveTitle = `Søknad kurs - Ex risiko i elektriske anlegg - ${xmlData.fornavn} ${xmlData.etternavn}`
  ...
  sharepointList: {
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return [
          {
            testListUrl: 'https://telemarkfylke.sharepoint.com/sites/FAGS-avdelingkursogetterutdanning/Lists/EXrisiko/AllItems.aspx',
            prodListUrl: 'https://telemarkfylke.sharepoint.com/sites/FAGS-avdelingkursogetterutdanning/Lists/EXrisiko/AllItems.aspx',
            uploadFormPdf: true,
