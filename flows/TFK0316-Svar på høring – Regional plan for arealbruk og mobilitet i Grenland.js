const description = 'TFK0317-Svar på høring – Regional plan for arealbruk og mobilitet i Grenland' // Required. A short searchable type-name that distinguishes the statistic element
      ...
      mapper: (flowStatus, base64, attachments) => {
        ...
        return {
          ...
          parameter: {
            ...
            CaseNumber: nodeEnv === 'production' ? '25/03268' : '25/00088'
          }
        }
      }
    }
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          description,
          type: 'Svar på høring - Svar på høring – Regional plan for arealbruk og mobilitet i Grenland', // Required. A short searchable type-name that distinguishes the statistic element
          // optional fields:
