...
module.exports = async (blobs, flowStatus) => {
  ...
  {
    logger.info('Running function - finding websak_hode.xml or {Skjemanavn}{_flowStatus.refId}.xml')
    ...
    result.files = files
    logger.info('Finished - websak_hode.xml or {Skjemanavn}{_flowStatus.refId}.xml: {fileName}', websakHodeBlob.name)
  }
