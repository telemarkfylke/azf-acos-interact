...
module.exports = async (blobs, flowStatus) => {
  let result = {}
  {
    ...
    logger.info('parse-xml: Finished - egendefinert avleveringsfil: {fileName}', xmlBlob.name)
  }
  {
    ...
    result.files = files
    logger.info('parse-xml: Finished - websak_hode.xml or {Skjemanavn}{_flowStatus.refId}.xml: {fileName}', websakHodeBlob.name)
  }
