...
module.exports = async (blobs, flowStatus) => {
  ...
  {
    logger.info('Running function - finding websak_hode.xml or {Skjemanavn} _ {flowStatus} .xml', flowStatus.acosName, flowStatus.refId)
    ...
    result.files = files
    logger.info('Finished - websak_hode.xml or {Skjemanavn} _ {flowStatus} .xml', flowStatus.acosName, flowStatus.refId)
  }
