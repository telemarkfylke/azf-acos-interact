...
module.exports = async (jobDef, flowStatus) => {
  ...
  for (const fileUpload of fileUploads) {
    try {
      ...
      logger.errorException(error, 'sharePointList: Failed when uploading file to SharePoint. fileName: {fileName}, fileDesc: {fileDesc}, siteName: {siteName}', fileUpload.file.name, fileUpload.file.desc, fileUpload.siteName)
    }
  }
