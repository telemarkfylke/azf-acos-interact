...
module.exports = async (jobDef, flowStatus) => {
  ...
  for (const fileUpload of fileUploads) {
    try {
      ...
      logger.errorException(error, 'sharePointList: Failed when uploading file to SharePoint. fileName: {fileName}, fileDesc: {fileDesc}, siteName: {siteName}. Error: {@message}', fileUpload.file.name, fileUpload.file.desc, fileUpload.siteName, errorMsg)
    }
  }
  ...
  logger.info('sharePointList: Successfully created {listItemCount} list items', payload.requests.length)
